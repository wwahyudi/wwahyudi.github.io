...
![nmap –sL](/images/2013-07-01-network-scanning/1.png)
...
![nmap –sP](/images/2013-07-01-network-scanning/2.png)
...
![nmap –sP –v](/images/2013-07-01-network-scanning/3.png)
...
![Hasil perintah nmap –F ke scanmap.eepis-its.edu](/images/2013-07-01-network-scanning/4.png)

Hasil perintah nmap –F ke scanmap.eepis-its.edu

![Hasil perintah nmap –sV ke scanmap.eepis-its.edu](/images/2013-07-01-network-scanning/5.png)
...
![Direktori tersimpannya scrip nmap dalam system](/images/2013-07-01-network-scanning/6.png)

Penggunaan dari scripts (-sC)

![Penggunaan dari scripts (-sC)](/images/2013-07-01-network-scanning/7.png)
...
![Hasil nmap –sC ke scanmap.eepis-its.edu](/images/2013-07-01-network-scanning/8.png)
...
![Hasil nmap –sS ke scanmap.eepis-its.edu](/images/2013-07-01-network-scanning/9.png)
...
![Hasil Listen paket antara host anda dan host target dengan menggunakan wireshark](/images/2013-07-01-network-scanning/10.png)
...
![Penggambaran diagram TCP menggunakan Wireshark](/images/2013-07-01-network-scanning/11.png)
