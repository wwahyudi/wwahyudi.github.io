...
![Skema jaringan yang diterapkan](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/1.png)
...
![konfigurasi file interfaces](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/2.png)
...
![konfigurasi file resolv.conf](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/3.png)
...
![Hasil instalasi ssh](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/4.png)
...
![Hasil instalasi apache2 dan openssl](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/5.png)
...
![Membuat rsa key](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/6.png)

Membuat certificate identity:

![Membuat file certificate](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/8.png)
...
![Hasil pengubahan SSLCertificateFile dan SSLCertificateKeyFile pada file default-ssl](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/9.png)
...
![enable ssl](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/10.png)
...
![Mengaktifkan default-ssl](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/11.png)
...
![Hasil restart apache2 service berhasil](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/12.png)

Dan hasilnya:

![http://localhost diakses](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/13.png)

http diakses

![https://localhost diakses](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/14.png)
...
![pengisian hostname pada /etc/squid/squid.conf](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/15.png)
...
![hasil eksekusi perintah #squid –z](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/16.png)
...
![hasil pembuatan ACL pada /etc/squid/squid.conf](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/17.png)

Setelah itu restart service squid untuk menerapkan hasil konfigurasi pada /etc/squid/squid.conf.

![restart service squid](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/18.png)
...
![contoh pembuatan user autentifikasi untuk squid](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/19.png)

Dan hasilnya

![browser yang sudah diset proxy-nya akan mngeluarkan autentifikasi seperti gambar diatas](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/20.png)
...
![Hasil akses proxy klien pada /var/log/squid/access.log](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/21.png)
...
![hasil seting file /etc/resolv.conf](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/22.png)
...
![hasil edit dari file database](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/23.png)

Edit juga file reverse menggunakan perintah #nano /var/cache/bind/kecut.com.rev. Berikut hasil edit dari file reverse:

![hasil edit dari file reverse](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/24.png)
...
![Hasil edit file /etc/bind/named.conf.local](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/25.png)
...
![Hasil edit file /etc/bind/named.conf.option](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/26.png)

Terakhir, restart services bind menggunakan perintah #/etc/init.d/bind9 restart.

![Restart service bind](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/27.png)

Hasil set up DNS dapat dicheck menggunakan dig

![nslookup ke www.kecut.com dan nslookup ke ip 192.168.1.85](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/28.png)
...
![Hasil assign ip ke eth2](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/29.png)

Setelah itu tambahkan route gateway address 192.168.1.1.

![Hasil menambahkan route gateway address 192.168.1.1](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/30.png)
...
![set dns router ke dns yang telah dibuat dan mengijinkan remote request](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/31.png)

Untuk memudahkan pengalamatan ip ke klien buat dhcp server pada mikrotik.

![set dhcp server pada mikrotik](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/32.png)

Terakhir buat scr nat dengan masquerade pada eth1

![set scr nat dengan masquerade pada eth1](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/33.png)
...
![Hasil assign IP DHCP dari mikrotik](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/34.png)

#### Uji DNS server

![Set resolver](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/35.png)
...
![nslookup ke www.kecut.com dan nslookup ke ip 192.168.1.85](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/36.png)

#### Uji webserver dan dns pada browser

![Hasil uji memanggil site pada webserver](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/37.png)

Coba buka web

![konfigurasi proxy pada client](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/39.png)

Konfigurasi proxy pada client

![browser yang sudah diset proxy-nya akan mngeluarkan autentifikasi seperti gambar diatas](http://sapikuda.com/images/posts/2013-07-02-virtual-private-server-sebagai-proxy-server-dan-web-server/40.png)
