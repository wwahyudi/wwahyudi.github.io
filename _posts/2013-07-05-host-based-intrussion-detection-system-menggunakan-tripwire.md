...
![Awal instalasi Tripwire](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system1.png)

Kemudian muncul dialog untuk meminta user membuat key passphrase, pilih yes.

![Konfirmasi untuk membuat paraphase](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system2.png)
...
![Warning kedua](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system3.png)
...
![Konfirmasi apakah key akan dibuat sebagai local key](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system4.png)
...
![Konfirmasi untuk me-rebuild file konfigurasi](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system5.png)
...
![Konfirmasi me-rebuild policy file](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system6.png)

Setelah itu, masukan key yang diinginkan dan ulangi pada langkah selanjutnya setelah memilih OK.

![Memasukan site-key passphrase](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system7.png)
...
![hasil tripwire sudah diinstal](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system8.png)
...
![Mengenkriptsi file twcfg.txt](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system9.png)
...
![Proses inisialisasi database Tripwire](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system10.png)
...
![Berikut hasil pengecekan](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system11.png)
...
![Mengupdate database tripwire](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system12.png)

Untuk mencoba sedikit kerja Tripware dilakukan percobaan sebagai berikut:

Pertama lakukan Tripwire check.

![Hasilnya](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system13.png)
...
![Perubuhan yang dimaksudkan](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system14.png)
...
![Perubahan konfigurasi smpt Tripwire](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system15.png)
...
![Test email](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system16.png)

Kemudian check email user

![Terdapat banyak email test karena email test yang dikirim berulang-ulang](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system17.png)
...
![Hasil pengecekan](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system18.png)
...
![Hasil perubahan](http://sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system19.jpg)