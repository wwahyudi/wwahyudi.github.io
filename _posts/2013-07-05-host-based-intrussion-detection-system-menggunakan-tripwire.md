...
![Awal instalasi Tripwire](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/1.png)

Kemudian muncul dialog untuk meminta user membuat key passphrase, pilih yes.

![Konfirmasi untuk membuat paraphase](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/2.png)
...
![Warning kedua](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/3.png)
...
![Konfirmasi apakah key akan dibuat sebagai local key](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/4.png)
...
![Konfirmasi untuk me-rebuild file konfigurasi](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/5.png)
...
![Konfirmasi me-rebuild policy file](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/6.png)

Setelah itu, masukan key yang diinginkan dan ulangi pada langkah selanjutnya setelah memilih OK.

![Memasukan site-key passphrase](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/7.png)
...
![hasil tripwire sudah diinstal](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/8.png)
...
![Mengenkriptsi file twcfg.txt](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/9.png)
...
![Proses inisialisasi database Tripwire](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/10.png)
...
![Berikut hasil pengecekan](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/11.png)
...
![Mengupdate database tripwire](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/12.png)

Untuk mencoba sedikit kerja Tripware dilakukan percobaan sebagai berikut:

Pertama lakukan Tripwire check.

![Hasilnya](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/13.png)
...
![Perubuhan yang dimaksudkan](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/14.png)
...
![Perubahan konfigurasi smpt Tripwire](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/15.png)
...
![Test email](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/16.png)

Kemudian check email user

![Terdapat banyak email test karena email test yang dikirim berulang-ulang](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/17.png)
...
![Hasil pengecekan](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/18.png)
...
![Hasil perubahan](//sapikuda.com/images/posts/2013-07-05-host-based-intrussion-detection-system/19.jpg)